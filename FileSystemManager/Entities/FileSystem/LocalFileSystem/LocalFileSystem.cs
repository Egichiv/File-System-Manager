...
public class LocalFileSystem : FileSystemBase
{
    ...
    {
        IFile fileToCopy = GetFileByPath(sourcePath);
        IDirectory destinationDirectory = GetDirectoryByPath(destinationPath);
    ...
    public override void DeleteFile(string path)
    {
        ...
        IDirectory parentDirectory = GetDirectoryByPath(parentDirectoryPath);
